...
(
    ...
    EXTEND_YN  VARCHAR2(20) NOT NULL,
...
COMMENT ON COLUMN sp_member.extends_yn IS '연장여부';
...
INSERT INTO SP_MEMBER VALUES (SEQ_MEMBER_CODE.NEXTVAL, 'user3', 'user3', '박후추', '여', '중급', '2022-01-01', 'Y', '2022-08-29');
INSERT INTO SP_MEMBER VALUES (SEQ_MEMBER_CODE.NEXTVAL, 'user4', 'user4', '박초희', '여', '고급', '2021-08-22', 'N', '2022-08-28');
INSERT INTO SP_MEMBER VALUES (SEQ_MEMBER_CODE.NEXTVAL, 'user5', 'user5', '김지은', '남', '입문', '2022-08-30', 'Y', '2022-08-21');
...
INSERT INTO SP_MEMBER VALUES (SEQ_MEMBER_CODE.NEXTVAL, 'user10', 'user10', '김슬기', '여', '중급', '2022-02-02', 'Y', '2022-08-31');
